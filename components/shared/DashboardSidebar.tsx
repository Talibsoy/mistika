...
const navItems = [
  ...
  { href: "/tarot", icon: "🔮", label: "Tarot Fal" },
  { href: "/yuxu", icon: "🌙", label: "Yuxu Yozma" },
  { href: "/burc", icon: "⭐", label: "Bürc" },
  { href: "/numerologiya", icon: "🔢", label: "Numerologiya" },
];
...
export default function DashboardSidebar({ user, trialDaysLeft, subStatus }: Props) {
  ...
  return (
    <aside style={{ width: 240, background: "#0d0d0d", borderRight: "1px solid #1a1a1a", display: "flex", flexDirection: "column", padding: "24px 16px", minHeight: "100vh", flexShrink: 0 }}>
      {/* Logo */}
      ...
      <div style={{ borderTop: "1px solid #1a1a1a", paddingTop: 16, marginTop: 16 }}>
        <div style={{ fontSize: 13, color: "#888", marginBottom: 4, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
